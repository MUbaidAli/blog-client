...
function PopularPost({ data }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-10 lg:px-8 py-10">
      <section className="mx-auto max-w-5xl px-4 sm:px-10 lg:px-8 py-10">
      ...
      <div className="slider flex sm:justify-between justify-center items-center relative overflow-hidden">
        ...
        >
          ...
          />
          <div className="slider-text m-0 sm:m-5 md:w-110 w-full">
            <div className="heading-text-section pb-8 pt-9">
              <h1
                className={`mb-4  h-full text-gray-900 dark:text-white  text-5xl sm:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#FF4242] to-[#99286C]`}
              >
                {data[counter]?.title}
              </h1>
              <p className={`text-white w-full text-1xl `}>
