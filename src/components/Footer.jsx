...
function Footer() {
  return (
    <>
      ...
      <footer className="">
        <div className="w-full min-h-screen flex items-center justify-center bg-black px-3 sm:px-8 pt-20">
          <div className="md:max-w-7xl w-full sm:px-4 px-3 text-white flex flex-col">
            <div className="w-full text-5xl sm:text-7xl font-bold">
              <h1 className="w-full md:w-2/3 text-transparent bg-clip-text bg-gradient-to-r from-[#FF4242] to-[#99286C]">
                Join Us For Awesome Shiny Blog Monthly Inslights
              </h1>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <p className="w-full text-center my-12 text-gray-600">
                Copyright © 2024 Blog.com
              </p>
            </div>
          </div>
        </div>

        {/* <div className="mx-auto max-w-7xl px-5 py-40">
